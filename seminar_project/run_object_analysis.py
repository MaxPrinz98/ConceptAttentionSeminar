...
def main():
    ...
    experiments = [
        ...
        # --- Group 7: Presentation ---
        {
            ...
            "cases": [
                {
                    "name": "nervous_student",
                    "prompt": "A nervous student giving a presentation about generative ai.",
                    "concept_sets": [
                        ["Student", "AI", "classroom", "presentation", "nervous"],
                    ],
                },
                {
                    "name": "relieved_student",
                    "prompt": "A relieved student after giving a presentation about generative ai.",
                    "concept_sets": [
                        ["Student", "AI", "classroom", "presentation", "relieved"],
                    ],
                },
                {
                    "name": "steampunk_owl",
                    "prompt": "A steampunk owl wearing a tiny brass top hat, perched on a glowing blue crystal, inside a dusty Victorian library",
                    "concept_sets": [
                        ["owl", "brass", "hat", "library", "crystal", "blue"],
                    ],
                },
            ],
        },
